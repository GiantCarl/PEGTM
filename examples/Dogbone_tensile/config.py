...
mesh_info_dict = {"mesh_file":"dogbone.msh",
                  "contain_self":True,
                  "fix_X_boundary":"left_edge",
                  "fix_Y_boundary":"left_edge",
                  "disp_X_boundary":'right_edge',
...
crack_dict = {"x_init" : [0.0], "y_init" : [0], "L_crack" : [0.5], "angle_crack" : [0]}


# Prescribed incremental displacement
loading_angle = torch.tensor([0])
disp =np.linspace(0.0, 0.32, 101)
...
model_path = PATH_ROOT/Path("model_type_" + network_dict["model_type"]+
                            "_aggregate_" + network_dict["aggregate_fun"]+

...
mesh_info_dict = {"mesh_file":"MultiCrack2.msh",
                  "contain_self":True,
...
'''
domain_extrema = torch.tensor([[-25, 25], [-25, 25]])
...
mat_prop_dict = {"Ture_mat_E" : 210, "mat_E" : 1.0, "mat_nu" : 0.3,
                 ...
                 "True_l0" : 0.5, "l0" : 0.5/L}

crack_dict = {"x_init" : [-6.5,-4.5,1.5,-6.5,-4.5,1.5,-6.5,-4.5,1.5,], 
              "y_init" : [-10,-10,-10,0.0,0.0,0.0,10,10,10], 
              "L_crack" : [1.41421356,4.2426407,7.07106781,1.41421356,4.2426407,7.07106781,1.41421356,4.2426407,7.07106781], 
              "angle_crack" : [np.pi/4,np.pi/4,np.pi/4,np.pi/4,np.pi/4,np.pi/4,np.pi/4,np.pi/4,np.pi/4]}


# Prescribed incremental displacement
loading_angle = torch.tensor([np.pi/2])
disp_transform_config = (mat_prop_dict["True_w1"]/mat_prop_dict["Ture_mat_E"] /mat_prop_dict["True_l0"])**(-0.5)/L
disp =np.linspace(0.0, 0.0045, 101) * disp_transform_config

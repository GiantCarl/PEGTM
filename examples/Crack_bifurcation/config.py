...
mesh_info_dict = {"mesh_file":"Crack_bifurcation.msh",
                  "contain_self":True,
                  "fix_X_boundary":"bottom_edge",
                  "fix_Y_boundary":"left_edge+bottom_edge+right_edge+top_edge",
...
crack_dict = {"x_init" : [-0.5], "y_init" : [0], "L_crack" : [0], "angle_crack" : [0]}

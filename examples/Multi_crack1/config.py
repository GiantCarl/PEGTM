...
mesh_info_dict = {"mesh_file":"MultiCrack1.msh",
                  "contain_self":True,
...
crack_dict = {"x_init" : [-12.5,-2.5,7.5], "y_init" : [-7.5,-2.5,2.5], "L_crack" : [7.0711,7.0711,7.0711], "angle_crack" : [np.pi/4,np.pi/4,np.pi/4]}

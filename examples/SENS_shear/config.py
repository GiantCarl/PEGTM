...
mesh_info_dict = {"mesh_file":"ShearPlate.msh",
                  "contain_self":True,
                  "fix_X_boundary":"bottom_edge",
                  "fix_Y_boundary":"bottom_edge+top_edge",
                  "disp_X_boundary":"top_edge",
                  "disp_Y_boundary":None,
                  "tract_X_boundary":None,
                  "tract_Y_boundary":None,
                  "elem_type":"triangle",
                  "Pre_Crack_type":"discrete"  #smeard  ,discrete   
                  }
...
PFF_model_dict = {"PFF_model" : 'AT2', "se_split" : 'volumetric', "tol_ir" : 1e-3}
mat_prop_dict = {"Ture_mat_E" : 210, "mat_E" : 1.0, "mat_nu" : 0.3,
                 "True_w1" : 0.0027, "w1" : 1.0,
                 "True_l0" : 0.01, "l0" : 0.01/L}

crack_dict = {"x_init" : [-0.5], "y_init" : [0], "L_crack" : [0.0], "angle_crack" : [0]}


# Prescribed incremental displacement
loading_angle = torch.tensor([0])
disp = np.concatenate((np.linspace(0.0, 0.5, 26), np.linspace(0.5, 1, 201)[1:]), axis=0) * 0.5
